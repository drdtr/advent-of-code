...
object Util {
    ...
    fun readInput(adventOfCodeYear: Int, adventOfCodeDay: Int, fileName: String): List<String> =
        readInput("puzzleInputs/$adventOfCodeYear/%02d/$fileName".format(adventOfCodeDay))
